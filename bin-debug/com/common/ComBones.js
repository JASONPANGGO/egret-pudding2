...
(function (com) {
    ...
    var ComBones = (function () {
         ...
         */
        ComBones.prototype.setData = function (parent, resName, exitAim, armatureName, dragonBonesName) {
            if (armatureName === void 0) { armatureName = "Armature"; }
            this.parent = parent;
         ...
         */
        ComBones.prototype.play = function (animationName, playTimes, isComRemve) {
            if (animationName === void 0) { animationName = "Armature"; }
         ...
         */
        ComBones.prototype.stop = function (animationName) {
            if (!this.init()) {
                return;
            }
         ...
         */
        ComBones.prototype.gotoAndStop = function (clipName, time) {
            if (!this.init()) {
                return;
            }
         ...
         */
        ComBones.prototype.gotoAndStopByTime = function (animationName, time) {
            if (!this.init()) {
                return;
            }
         ...
         * 设置缩放值
         */
        ComBones.prototype.setScale = function (x, y) {
            if (x == void 0) {
                return;
            }
            x = x || 0;
         ...
         * 设置位置
         */
        ComBones.prototype.setPos = function (pos) {
            if (!pos) {
                return;
            }
            pos.x = pos.x || 0;
         ...
         * 设置初始位置
         */
        ComBones.prototype.setInitPos = function (pos) {
            if (!pos) {
                return;
            }
            pos.x = pos.x || 0;
         ...
         * 设置初始位置
         */
        ComBones.prototype.setDiffPos = function (pos) {
            if (!pos) {
                return;
            }
         ...
         * 设置层级
         */
        ComBones.prototype.setIndex = function (index) {
            if (index == void 0) {
                return;
            }
            index = index || 0;
        ...
        /** 设置遮罩 */
        ComBones.prototype.setMask = function (mask) {
            if (!this.armatureDisplay) {
                return;
            }
        ...
        /** 设置透明度 */
        ComBones.prototype.setAlpha = function (alpha) {
            if (alpha == void 0) {
                return;
            }
            if (!this.parent || !this.armatureDisplay) {
        ...
        /** 显示 */
        ComBones.prototype.show = function () {
            if (!this.armatureDisplay) {
                return;
            }
        ...
        /** 隐藏 */
        ComBones.prototype.hide = function () {
            if (!this.armatureDisplay) {
                return;
            }
         ...
         * 播放完成
         */
        ComBones.prototype.playComplete = function () {
            this.armatureDisplay.removeEvent(dragonBones.EgretEvent.COMPLETE, this.playComplete, this);
            if (this.exitAim) {
                this.playOutAim();
            }
         ...
         * 播放退场动画
         */
        ComBones.prototype.playOutAim = function () {
            var _this = this;
            var _props;
            ...
            egret.setTimeout(function () {
                gTween.tween(_this.armatureDisplay, void 0, {
                    props: _props,
                    duration: _this.exitAim.time,
                    call: {
                        callback: function () {
                            _this.armatureDisplay.dispatchEventWith(egret.Event.COMPLETE);
                            if (_this.isComRemve) {
                                _this.remove();
                            }
                        },
         ...
         * 移除骨骼的显示容器
         */
        ComBones.prototype.remove = function () {
            gComMgr.rmObj(this.armatureDisplay);
        };
        /**
         * 创建骨架的显示容器
         */
        ComBones.prototype.create = function () {
            if (!this.resName) {
                return;
            }
         ...
         */
        ComBones.prototype.replaceDisplay = function (resName, dragonBonesName, armatureName, slotName, displayName, olgSlotName, displayIndex) {
        ...
        /** 设置or获取对应指引方向 */
        ComBones.prototype.guideDir = function (guideDir) {
            if (guideDir != void 0) {
        ...
        /** 设置or获取对应指引方向 */
        ComBones.prototype.screenType = function (screenType) {
        ...
        /** 获取宽 */
        ComBones.prototype.getWidth = function () {
            if (!this.armatureDisplay) {
                return;
            }
        ...
        /** 获取高 */
        ComBones.prototype.getHeight = function () {
            if (!this.armatureDisplay) {
                return;
            }
    ...
    com.ComBones = ComBones;
    __reflect(ComBones.prototype, "com.ComBones");
})(com || (com = {}));
//# sourceMappingURL=ComBones.js.map