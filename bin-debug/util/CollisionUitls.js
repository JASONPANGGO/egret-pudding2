...
(function (util) {
    var CollisionUitls = (function () {
         ...
         * 检测两个对象外围矩形框是否相交
         */
        CollisionUitls.checktObjPolygon = function (obj1, obj2) {
            var obj1PointList = this.getRectangleVerPoints(obj1);
            var obj2PointList = this.getRectangleVerPoints(obj2);
        ...
        /** 转换成一组世界坐标 */
        CollisionUitls.switchGlobalPoint = function (obj, objPoints) {
            var pos;
            for (var i = 0; i < objPoints.length; i++) {
                var point = objPoints[i];
    ...
    util.CollisionUitls = CollisionUitls;
    __reflect(CollisionUitls.prototype, "util.CollisionUitls");
})(util || (util = {}));
//# sourceMappingURL=CollisionUitls.js.map